...
setwd("C:/Users/fhsepulveda/OneDrive - Universidad de Medellin/Shape.Bucaramanga")
Y = readOGR("Perimetro_Bucara.shp")
plot(Y, main="Perímetro de Bucaramanga")
X = readOGR("Comunas.shp")
...
#-------Salud Pública-------#
setwd("C:/Users/fhsepulveda/OneDrive - Universidad de Medellin/Shape.Bucaramanga/Delitos")
...
#-------CV-------------#
setwd("C:\\Users\\fhsepulveda\\OneDrive - Universidad de Medellin\\Documents\\Curso Estadística Espacial\\Parciales")
